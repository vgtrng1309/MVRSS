...
for seq in seq_list:
    ...
    for i in range(n_frame):
        ...
        ra_frames, rd_frames, ra_masks, rd_masks = load_data_frame(data_dir + seq + "/", box_idx)
        ...
        for k in range(1,4):
            ...
            for k_ra_box, k_rd_box in zip(k_ra_boxes, k_rd_boxes):
                ...
                r, a = get_bin_index(ra_box_center, is_range_angle=True)
                r = GRID_SIZE-r-1
                _, d = get_bin_index(rd_box_center, is_range_angle=False)
                # print(r, a, d, end=" ")
                # boxes mask
